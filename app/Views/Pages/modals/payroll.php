          ...
          <div class="row">
            <div class="col mb-3">
              ...
              <div class="d-flex justify-content-between mb-3">
                ...
                <input type="date" class="form-control w-65 salaryFormat" name="upayrollDateFrom" id="upayrollDateFrom">
              </div>
              <div class="d-flex justify-content-between mb-3">
                <label class="form-label align-self-center mb-0 w-50">Date To</label>
                <input type="date" class="form-control w-65 salaryFormat" name="upayrollDateTo" id="upayrollDateTo">
              </div>
              <div class="d-flex justify-content-between mb-3">
                  <label class="form-label align-self-center mb-0 w-50">Payment Method</label>
                  <select class="form-select w-65" name="upayrollPaymentMethod" id="upayrollPaymentMethod" required>
              ...
              <div class="d-flex justify-content-between mb-3">
                ...
                <textarea class="form-control w-65" id="upayrollComment" name="upayrollComment" rows="5"></textarea>
              </div>
            </div>
          </div>
        </div>
...
<div class="modal fade" id="calculatePayroll" tabindex="-1" role="dialog" aria-labelledby="Modal Delete" aria-hidden="false">
  <?php echo form_open(site_url('payroll/calculate'));?>
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <input type="hidden" id="calPayrollId" name="calPayrollId">
          <input type="hidden" id="calPayrollDateFrom" name="calPayrollDateFrom">
          <input type="hidden" id="calPayrollDateTo" name="calPayrollDateTo">
          <p class="modal-title" id="exampleModalLabel1">Calculate Now?</p>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-footer">
