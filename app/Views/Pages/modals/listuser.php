        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <div class="d-flex justify-content-between mb-3">
                <label class="form-label align-self-center mb-0 w-50">User Number</label>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="d-flex justify-content-between mb-3">
                <label class="form-label align-self-center mb-0 w-50">Phone Number</label>
                <input type="text" class="form-control w-12 me-2" value="<?=$phoneCode?>" disabled>
                <input type="text" class="form-control w-85" name="userPhoneNumber" id="userPhoneNumber">
              </div>
              <div class="d-flex justify-content-between mb-3">
                <label class="form-label align-self-center mb-0 w-50">Gender</label>
                <select class="form-select w-65" name="userGender" id="userGender" required>
