<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item" role="presentation">
    <button class="nav-link" id="allowance-tab" data-bs-toggle="tab" data-bs-target="#allowance" type="button" role="tab" aria-controls="home" aria-selected="true">Allowance</button>
  </li>
  <li class="nav-item" role="presentation">
...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show" id="allowance" role="tabpanel" aria-labelledby="allowance-tab">
