<button type="button" class="btn btn-default w-25 mt-3" data-bs-toggle="modal" data-bs-target="#insertLeave">New Leave</button>
...
<script>
  $(document).ready(function(){
    ...
    $('.approveLeave').on('click', function(){
      ...
      $('#approveidLeave').val(id);
    })
    
    $('.declineLeave').on('click', function(){
      var id = $(this).attr('data-id');
      $('#declineidLeave').val(id);
    })
